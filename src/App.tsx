    ...
    <div className="page-shell">
      ...
      <div className={`floating-chat ${isChatOpen ? 'floating-chat--open' : ''}`}>
        ...
        <button
          ...
          aria-label={isChatOpen ? 'Cerrar chat de WhatsApp' : 'Abrir chat de WhatsApp'}
        >
          <svg className="floating-chat__toggle-icon" viewBox="0 0 32 32" aria-hidden="true">
            <path d="M19.11 17.27c-.29-.15-1.71-.84-1.98-.94-.26-.1-.45-.15-.64.15-.19.29-.74.94-.9 1.13-.17.2-.33.22-.62.08-.29-.15-1.2-.44-2.29-1.4-.85-.75-1.43-1.68-1.6-1.97-.17-.29-.02-.45.13-.6.13-.13.29-.33.43-.49.14-.17.19-.29.29-.49.1-.2.05-.37-.02-.52-.08-.15-.64-1.55-.88-2.13-.23-.55-.47-.47-.64-.48h-.55c-.19 0-.49.07-.74.34-.26.29-.99.97-.99 2.36s1.01 2.72 1.15 2.91c.14.2 1.97 3 4.78 4.2.67.29 1.2.46 1.61.59.68.21 1.3.18 1.79.11.55-.08 1.71-.7 1.95-1.38.24-.68.24-1.25.17-1.37-.07-.12-.26-.2-.55-.34Z" />
            <path d="M27.2 15.63c0 6.17-5.02 11.19-11.2 11.19-1.97 0-3.9-.52-5.59-1.5L4.8 27.2l1.92-5.47a11.13 11.13 0 0 1-1.9-6.1c0-6.17 5.02-11.2 11.18-11.2 2.99 0 5.8 1.16 7.91 3.28a11.1 11.1 0 0 1 3.29 7.92Zm-11.2-9.3c-5.13 0-9.3 4.18-9.3 9.31 0 1.77.5 3.5 1.46 4.99l.23.35-1.14 3.25 3.33-1.1.34.2a9.23 9.23 0 0 0 4.51 1.17c5.13 0 9.3-4.18 9.3-9.31 0-2.49-.97-4.83-2.73-6.59A9.24 9.24 0 0 0 16 6.33Z" />
          </svg>
        </button>
      </div>
    </div>
